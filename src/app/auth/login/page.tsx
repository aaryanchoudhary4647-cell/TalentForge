      ...
      >
        ...
        <div className="absolute top-0 left-0 w-1/2 h-full z-0 flex items-center justify-center">
          <LoginForm
            ...
            role="candidate"
            isFlipped={flipped} // To reset state when hidden
          />
        </div>
        ...
        {/* Flipping Page (Hinged at Center Spine) */}
        <div
        ...
        >
          {/* FRONT: HR Invite (Covers the right panel) */}
          <InviteFace
            faceSide="front"
            icon={<HRSvg />}
          ...
          {/* BACK: Candidate Invite (Covers the left panel) */}
          <InviteFace
            faceSide="back"
            icon={<ApplicantSVG />}
