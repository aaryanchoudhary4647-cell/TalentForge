...
export default function HRDashboard() {
  ...
  // Fetch real jobs from Supabase when component mounts
  React.useEffect(() => {
      ...
      <div className="pl-60">
        <div className="p-8 max-w-5xl">
          ...
          <div className="flex items-center justify-between mb-8">
            ...
            <Button size="sm" className="gap-2" onClick={() => router.push('/hr/jobs')}>
            ...
            <div className="space-y-4">
              {jobsLoading ? (
                ...
                <Card className="p-8 text-center">
                  ...
                  <p className="text-slate-600 dark:text-slate-400 mb-4">No job postings yet</p>
                  <Button size="sm" className="gap-2" onClick={() => router.push('/hr/jobs')}>
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-1">
                          <h3 className="text-slate-900 dark:text-white font-extrabold">{j.job_title || j.title}</h3>
                          <Badge label={j.job_type || j.level} className="text-primary border-primary/20 bg-primary/10" />
                        </div>
                        <p className="text-slate-500 text-sm line-clamp-2 mb-3">{j.job_description || j.description}</p>
